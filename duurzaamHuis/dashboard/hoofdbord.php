    ...
    <div class="app-shell pdf-layout sidebar-hidden">
        ...
        <main class="content">
            ...
            <section class="pdf-module-board" aria-label="EcoPulse module layout">
                <?php
                    include 'tijdsspanne/tijdsspanne-kaart.php';
                    include 'datum-en-tijd/datumtijd-kaart.php';
                    include 'knopjes-voor-licht/licht-kaart.php';
                    include 'gas-verbruik/gas-kaart.php';
                    include 'water-verbruik/water-kaart.php';
                    include 'weersverwachting/weer-kaart.php';
                    include 'gebruik-electriciteit/electriciteit-kaart.php';
                    include 'opbrengst-zonnepanelen/zonnepaneel-kaart.php';
                    include 'temperatuur-binnen-buiten/temp-kaart.php';
                ?>
            </section>
            ...
            <?php include 'energie-grafiek/energie-grafiek-kaart.php'; ?>
